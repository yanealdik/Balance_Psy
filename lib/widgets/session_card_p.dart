...
class SessionCardP extends StatelessWidget {
  ...
  final VoidCallback? onDetailsTap; // ✅ ДОБАВЛЕНО

  const SessionCardP({
    super.key,
    required this.session,
    required this.onChatTap,
    this.onDetailsTap, // ✅ ДОБАВЛЕНО
  });
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: onDetailsTap, // ✅ ДОБАВЛЕНО: тап по всей карточке
      child: Container(
          ...
          children: [
            Row(
              children: [
                ...
                // ✅ ДОБАВЛЕНО: Иконка для перехода к деталям
                Icon(
